...
<html>
    <head>
        ...
        <link href='https://fonts.googleapis.com/css?family=Overlock:400italic,700italic' rel='stylesheet' type='text/css'>
        <!--Import materialize.css-->
        <link type="text/css" rel="stylesheet" href="<?= base_url('assets/materialize/css/materialize.min.css'); ?>"  media="screen,projection"/>
        <link type="text/css" rel="stylesheet" href="<?= base_url('assets/materialize/css/style.css'); ?>"  media="screen,projection"/>
    ...
    <body>
        ...
        <p class = "logo valign">"Quote Me On That"</p>
